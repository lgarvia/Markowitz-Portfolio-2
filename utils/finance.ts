import { GeminiFinancialResponse, PortfolioPoint, SimulationResult, StockData } from "../types";
...
export const runSimulation = (data: GeminiFinancialResponse, riskFreeRate: number): SimulationResult => {
